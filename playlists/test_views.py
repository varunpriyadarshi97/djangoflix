...
class PlaylistViewTestCase(TestCase):
    ...
    def test_show_list_view(self):
        ...
        self.assertQuerysetEqual(shows_qs.order_by(
            '-timestamp'), r_qs.order_by("-timestamp"))
    ...
    def test_movie_list_view(self):
        ...
        context = response.context
        r_qs = context['object_list']
        self.assertQuerysetEqual(movies_qs.order_by(
            '-timestamp'), r_qs.order_by("-timestamp"))
    ...
    def test_search_none_view(self):
        ...
        context = response.context
        r_qs = context['object_list']
        self.assertQuerysetEqual(ply_qs.order_by(
            '-timestamp'), r_qs.order_by("-timestamp"))
