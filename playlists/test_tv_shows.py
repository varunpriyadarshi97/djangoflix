...
class TVShowProxyModelTestCase(TestCase):
    ...
    def create_videos(self):
        video_a = Video.objects.create(
            title='My Title', video_id='abc123')
        video_b = Video.objects.create(
            title='My Title', video_id='abc1234')
        video_c = Video.objects.create(
            title='My Title', video_id='abc12345')
    ...
    def test_seaseon_slug_unique(self):
    ...
    def test_video_playlist_ids_property(self):
        ...
        actual_ids = list(TVShowProxy.objects.all().filter(
